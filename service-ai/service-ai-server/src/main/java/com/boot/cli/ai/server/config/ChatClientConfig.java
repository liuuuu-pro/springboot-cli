package com.boot.cli.ai.server.config;

import cn.hutool.core.collection.CollUtil;
import com.boot.cli.ai.server.config.properties.GoogleGenAiProperties;
import com.boot.cli.ai.server.config.properties.OpenaiCompatibleProperties;
